...
public class OutboxRecordMapper {
    ...
    public Object mapRecordToJson(TransactionOutboxRecord record) {
        ...
        return switch (eventType) {
            ...
            case EQUIPMENT_CREATED -> objectMapper.readValue(payload, EquipmentCreatedEvent.class);
            ...
            case SAFETY_INSTRUCTION_CREATED -> objectMapper.readValue(payload, SafetyInstructionCreatedEvent.class);
            ...
            case MATERIAL_CREATED -> objectMapper.readValue(payload, MaterialCreatedEvent.class);
